  ...
  const slides = [
    {
      ...
      body: "Across history, those who endured and led were never truly alone. They maintained ties, exchanged ideas, and leaned on others. There is a quiet strength in staying connected.",
      accent: null,
    },
    {
      emoji: "🔗",
      title: "Connection Compounds",
      body: "Consistent, meaningful connection improves resilience, strengthens mental health, and opens doors that effort alone cannot. The one who reaches out moves further than the one who waits.",
      accent: null,
    },
    {
      emoji: "🎯",
      title: "Simple, Not Easy",
      body: "Each day, choose one person — someone you respect, care about, or haven't spoken to in a while. Reach out with intention. Say something real. Ask something real.",
      accent: "Clarity comes from action, not overthinking.",
    },
    {
      emoji: "⚡",
      title: "Then Follow Through",
      body: "Answer the prompts: Who do you need to contact? Why does it matter? What will you say? How will you reach them?",
      accent: "Then follow through.",
    },
  ];
      ...
      <div style={{ minHeight: "100vh", padding: "24px 20px 120px", animation: "fadeIn 0.3s ease", display: "flex", flexDirection: "column", position: "relative" }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            {prepSlide === 0 && (
              <div style={{ fontSize: 11, color: C.textMuted, letterSpacing: 2, textTransform: "uppercase" }}>Rally Your Allies</div>
            )}
          </div>
